...
public class provider {
    ...
    public provider(int provider_id, String username, String password, String first_name, String last_name, String city, int phone, String mail, float rating, String experience, int like_nb, int confirmation, String Category) {
