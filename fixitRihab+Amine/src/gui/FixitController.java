 ...
 * @author LENOVO
 */
public class FixitController implements Initializable {
    ...
    @FXML
    private void autheAdmin(ActionEvent event) throws IOException{
      
       FXMLLoader loader = new FXMLLoader(getClass().getResource("autheAdmin.fxml"));
            Parent root = loader.load();  
            //ClientController controller = loader.<ClientController>getController();
            //controller.setUser(user);
