...
public class Ads {
    ...
    public static String ad_name, description,mail, image,first_name,last_name,city;
    ...
    public Ads(int ad_id,String ad_name,String first_name,String last_name,String city,Date availability,int phone,String mail,float rating,String image,Timestamp published_at) {
